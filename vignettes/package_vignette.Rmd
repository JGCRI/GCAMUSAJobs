...
This step plots the employment factor from the JEDI (https://www.nrel.gov/analysis/jedi/models.html) model. Please refer to the documentation (https://github.com/JGCRI/GCAMUSAJobs/blob/paper/docs/tutorials/Documentation_GCAMUSAJobs.docx) for details. Each point represents the employment factor of a state.
